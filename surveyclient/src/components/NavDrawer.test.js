...
describe("component NavDrawer", () => {
  ...
  it("default render - with answers", () => {
    ...
    const expectedItemContent = [
      ...
      "3Play in Your Grounds[19.047619047619047,17 questions remaining,4/21]",
      "4Wellbeing[61.53846153846154,5 questions remaining,8/13]",
      "5Sustainability[38.888888888888886,11 questions remaining,7/18]",
  ...
  it("default render - no answers", () => {
    ...
    const expectedItemContent = [
      ...
      "3Play in Your Grounds[0,21 questions remaining,0/21]",
      "4Wellbeing[0,13 questions remaining,0/13]",
      "5Sustainability[0,18 questions remaining,0/18]",
